...
// This file contains all controls from the 2022 standard
// Priority: Organizational (A.5) and People (A.6) have detailed data
// Physical (A.7) and Technological (A.8) have baseline data

export const annexAControls2022 = [
  // ====================================
  // A.5 - ORGANIZATIONAL CONTROLS (28 controls)
  // ====================================
  {
    id: 'A.5.1',
  ...
  },
  {
    ...
    description: 'Personnel and other interested parties as appropriate should return all of the organization assets in their possession upon termination of their employment, contract or agreement.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  ...
  },
  {
    ...
    description: 'The full life cycle of identities should be managed.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  {
    ...
    description: 'Allocation and management of authentication information should be controlled by a management process, including advising personnel on appropriate handling of authentication information.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  {
    ...
    category: 'ORGANIZATIONAL',
    title: 'Access rights',
    description: 'Access rights to information and other associated assets should be provisioned, reviewed, modified and removed in accordance with the organization topic-specific policy on and rules for access control.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  {
    ...
    description: 'Processes and procedures should be defined and implemented to manage the information security risks associated with the use of supplier products or services.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  ...
  },
  {
    ...
    description: 'Processes for acquisition, use, management and exit from cloud services should be established in accordance with the organization information security requirements.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  ...
  },
  {
    ...
    description: 'Legal, statutory, regulatory and contractual requirements relevant to information security and the organization approach to meet these requirements should be identified, documented and kept up to date.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  ...
  },
  {
    ...
    description: 'Records should be protected from loss, destruction, falsification, unauthorized access and unauthorized release.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  {
    ...
    description: 'The organization should identify and meet the requirements regarding the preservation of privacy and protection of PII according to applicable laws and regulations and contractual requirements.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  {
    ...
    description: 'The organization approach to managing information security and its implementation including people, processes and technologies should be reviewed independently at planned intervals, or when significant changes occur.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  {
    ...
    description: 'Compliance with the organization information security policy, topic-specific policies, rules and standards should be regularly reviewed.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  ...
  },
  {
    ...
    description: 'Personnel of the organization and relevant interested parties should receive appropriate information security awareness, education and training and regular updates of the organization information security policy, topic-specific policies and procedures, as relevant for their job function.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  ...
  },
  {
    ...
    description: 'Confidentiality or non-disclosure agreements reflecting the organization needs for the protection of information should be identified, documented, regularly reviewed and signed by personnel and other relevant interested parties.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  {
    ...
    description: 'Security measures should be implemented when personnel are working remotely to protect information accessed, processed or stored outside the organization premises.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  ...
  },
  {
    ...
    category: 'PHYSICAL',
    title: 'Storage media',
    description: 'Storage media should be managed through their life cycle of acquisition, use, transportation and disposal in accordance with the organization classification scheme and handling requirements.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  ...
  },
  {
    ...
    description: 'Information about technical vulnerabilities of information systems in use should be obtained, the organization exposure to such vulnerabilities should be evaluated and appropriate measures should be taken.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  ...
  },
  {
    ...
    category: 'TECHNOLOGICAL',
    title: 'Data masking',
    description: 'Data masking should be used in accordance with the organization topic-specific policy on access control and other related topic-specific policies, and business requirements, taking applicable legislation into consideration.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
  ...
  },
  {
    ...
    description: 'Groups of information services, users and information systems should be segregated in the organization networks.',
    status: 'pending',
    rating: 0,
    baselineMaturity: 'not-assessed'
  },
